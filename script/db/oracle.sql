...
(
    ...
    INVOICE_BASE64 CLOB,
    STATUS         VARCHAR2(30) NOT NULL CHECK (STATUS IN ('IN_PROCESSING', 'PROCESSED', 'ERROR'))
...
-- DROP
DROP USER ECOMMERCE_CHECKOUT_OWNER CASCADE;
DROP TABLESPACE TS_ECOMMERCE_CHECKOUT_DAT INCLUDING CONTENTS AND DATAFILES;